                            ...
                            <div class="slider-fixed-content">
                                <div id="slide-inner-temporary" class="fadeout-element">
                                    <div id="slide-inner-caption" class="content-full-width text-align-center height-title">
                                        <div class="inner">
                                            <h1 class="slide-hero-title caption-timeline primary-font-title"><span>Arxiv</span></h1>
                                            <div class="slide-hero-subtitle caption-timeline">
                                                <span>BU LOYIHALAR YO'QOLIB KETISHI UCHUN JUDA QIMMATLI. <br class="destroy"> BU BIZNING BAG'ISHLANGANLIGIMIZ, IJODKORLIGIMIZ VA MEHNATIMIZNING MOHIYATINI IFODALAYDI.</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
