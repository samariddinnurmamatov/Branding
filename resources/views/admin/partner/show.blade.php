                    ...
                    <div class="col-lg-6">
                        <div class="d-none d-lg-block">
                            <ol class="breadcrumb m-0 float-end">
                                <li class="breadcrumb-item"><a href="{{ route('partners.index') }}">Bosh sahifa</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <a href="{{ route('partners.edit', $partner->id) }}" class="btn btn-primary btn-squared px-30 mb-3">O'zgartirish</a><br>
