    ...
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="card-body py-md-30">
                <form action="{{ route('abouts.update', $about->id) }}" method="post" enctype="multipart/form-data" onsubmit="updateEditorContent()">
                    @csrf
                    @method('PUT')
                    {{-- uz --}}
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="layout-button mt-0">
                                <a href="{{ route('abouts.index') }}" class="btn btn-default btn-squared btn-light px-20">Cancel</a>
