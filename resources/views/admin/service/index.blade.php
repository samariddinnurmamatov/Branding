...
<x-layouts.admin>
        <div class="px-3">
            ...
            <div class="container-fluid">
                ...
                <div class="row mb-3">
                    <div>
                        <a class="btn btn-primary" href="{{ route('services.create') }}">Yaratish</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="mx-1 d-inline-block">
                                                    <a href="{{ route('services.edit', $service->id) }}"><i class="mdi mdi-book-edit-outline fs-3"></i></a>
                                                </div>
                                                <div class="mx-1 d-inline-block">
                                                    <a href="{{ route('services.show', $service->id) }}"><i class="mdi mdi-eye fs-3"></i></a>
                                                </div>
                                                <div class="mx-1 d-inline-block">
                                                    <form action="{{ route('services.destroy', $service->id) }}" method="POST" onsubmit="return confirm('Ochirishga ruxsat berasizmi')">
                                                        @csrf
                                                        @method('DELETE')
