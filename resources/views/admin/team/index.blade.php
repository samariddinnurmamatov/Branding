...
<x-layouts.admin>
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                <div>
                    <a class="btn btn-primary" href="{{ route('teams.create') }}">Yaratish</a>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="mx-1 d-inline-block">
                                                <a href="{{ route('teams.edit', $new->id) }}"><i class="mdi mdi-book-edit-outline fs-3"></i></a>
                                            </div>
                                            <div class="mx-1 d-inline-block">
                                                <a href="{{ route('teams.show', $new->id) }}"><i class="mdi mdi-eye fs-3"></i></a>
                                            </div>
                                            <div class="mx-1 d-inline-block">
                                                <form action="{{ route('teams.destroy', $new->id) }}" method="POST" onsubmit="return confirm('Ochirishga ruxsat berasizmi')">
                                                    @csrf
                                                    @method('DELETE')
