    ...
    <div class="px-3">
        ...
        <div class="container-fluid">
            ...
            <div class="card-body py-md-30">
                <form action="{{ route('portfolios.update', $portfolio->id) }}" method="post" enctype="multipart/form-data" onsubmit="updateEditorContent()">
                    @csrf
                    @method('PUT')
                    {{-- uz --}}
                    <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-25">
                            <input type="file" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="image1" placeholder="Rasmni kiriting">
                            @if ($portfolio->image1)
                                <img src="{{ asset('storage/' . $portfolio->image1) }}" alt="Logo" class="img-fluid">
                            @endif
                        </div>
                        <div class="col-md-4 mb-25">
                            <input type="file" class="form-control ih-medium ip-gray radius-xs b-light px-15" name="image2" placeholder="Rasmni kiriting">
                            @if ($portfolio->image2)
                                <img src="{{ asset('storage/' . $portfolio->image2) }}" alt="Logo" class="img-fluid">
                            @endif
                        </div>
                        <div class="col-md-6">
